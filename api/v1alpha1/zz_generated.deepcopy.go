...
func (in *CustomCASelector) DeepCopyInto(out *CustomCASelector) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomCASelector.
func (in *CustomCASelector) DeepCopy() *CustomCASelector {
	if in == nil {
		return nil
	}
	out := new(CustomCASelector)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KopiaMaintenanceSpec) DeepCopyInto(out *KopiaMaintenanceSpec) {
	*out = *in
	if in.RepositorySelector != nil {
		...
		*out = new(KopiaRepositorySelector)
		(*in).DeepCopyInto(*out)
	}
...
func (in *KopiaMaintenanceStatus) DeepCopyInto(out *KopiaMaintenanceStatus) {
	*out = *in
	if in.MatchedSources != nil {
		in, out := &in.MatchedSources, &out.MatchedSources
		*out = make([]MatchedSource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ActiveCronJobs != nil {
		in, out := &in.ActiveCronJobs, &out.ActiveCronJobs
	...
	if in.ConflictingMaintenances != nil {
		in, out := &in.ConflictingMaintenances, &out.ConflictingMaintenances
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KopiaRepositorySelector) DeepCopyInto(out *KopiaRepositorySelector) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KopiaRepositorySelector.
func (in *KopiaRepositorySelector) DeepCopy() *KopiaRepositorySelector {
	if in == nil {
		return nil
	}
	out := new(KopiaRepositorySelector)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MaintenanceCronJobSpec) DeepCopyInto(out *MaintenanceCronJobSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MaintenanceCronJobSpec.
func (in *MaintenanceCronJobSpec) DeepCopy() *MaintenanceCronJobSpec {
	if in == nil {
		return nil
	}
	out := new(MaintenanceCronJobSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatchedSource) DeepCopyInto(out *MatchedSource) {
	*out = *in
	if in.LastMatched != nil {
		in, out := &in.LastMatched, &out.LastMatched
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatchedSource.
func (in *MatchedSource) DeepCopy() *MatchedSource {
	if in == nil {
		return nil
	}
	out := new(MatchedSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReplicationSourceKopiaSpec) DeepCopyInto(out *ReplicationSourceKopiaSpec) {
	*out = *in
	...
	if in.MaintenanceCronJob != nil {
		in, out := &in.MaintenanceCronJob, &out.MaintenanceCronJob
		*out = new(MaintenanceCronJobSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Actions != nil {
